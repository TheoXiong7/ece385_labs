...
HD_PWD='C:/Users/tyxiong2/Desktop/lab6_1/lab6_1.runs/mp_block_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp_block_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp_block_dlmb_bram_if_cntlr_0.tcl
